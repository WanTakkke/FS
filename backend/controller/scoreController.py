...
async def get_score(
    ...
    _: object = Depends(require_permission("score:read")),
):
...
async def get_score_by_conditions(
    query_params: ScoreQueryRequest,
    db: AsyncSession = Depends(get_db),
    _: object = Depends(require_permission("score:read")),
):
...
async def add_score(
    ...
    db: AsyncSession = Depends(get_db),
    _: object = Depends(require_permission("score:create")),
):
    try:
...
async def update_score(
    ...
    db: AsyncSession = Depends(get_db),
    _: object = Depends(require_permission("score:update")),
):
    try:
        logger.info(
...
async def delete_score_by_student_and_exam(
    student_code: str,
    exam_sequence: str,
    db: AsyncSession = Depends(get_db),
    _: object = Depends(require_permission("score:delete")),
):
    try:
