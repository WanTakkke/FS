...
async def get_student(
    ...
    _: object = Depends(require_permission("student:read")),
):
...
async def add_student(
    ...
    db: AsyncSession = Depends(get_db),
    _: object = Depends(require_permission("student:create")),
):
    try:
...
async def update_student(
    ...
    db: AsyncSession = Depends(get_db),
    _: object = Depends(require_permission("student:update")),
):
    try:
...
async def delete_student(
    student_code: str,
    db: AsyncSession = Depends(get_db),
    _: object = Depends(require_permission("student:delete")),
):
    try:
